...
$(function() {
    ...
    $.fn.sparkle = function(options) {
        ...
        return this.each(function(k, v) {
            ...
            // TN Edit: Removed Mouseover events
        ...
        "update": function() {
            ...
            this.anim = window.requestAnimationFrame(function(time) {
                ...
                for (var i = 0; i < _this.particles.length; i++) {
                    ...
                    if (randX) {
                        p.position.x += ((p.delta.x * (_this.options.speed / _this.options.factor || 1)) / 1500);
                    }

                    // arbitrary position change/speed based on what felt good.
                    if (randY) {
                        p.position.y -= ((p.delta.y * (_this.options.speed / _this.options.factor || 1)) / 800);
                    }
